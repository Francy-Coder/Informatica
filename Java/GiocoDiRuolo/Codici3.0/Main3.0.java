        ...
        try{
            ...
            while (sceltaMenu != 2) {
                //Fare: (Controllare anche CosaManca2.0-3.0)
                    ...
                    //(Opzionale) Aggiungere / Modificare le parti nuovi fatte
                        ...
                        //Si potrebbe aggiungere una cartella log e al interno inserire un file.txt tramite lo Stream
                            //Si pottrebe aggiungere un cartella log e al interno inserire un file.txt tramite lo Stream con tutti i salvataggi del gioco
                ...
                if (primaVolta) {
                    ...
                    long tempoTotaleSecondi = (tempoFine - tempoInizio) / 1_000_000_000;

                    stampaConDelay("\n💀 Sei morto. La tua avventura termina qui.");
                    stampaConDelay("⏳ Tempo di gioco: " + tempoTotaleSecondi + " secondi");
                    ...
                    if(sceltaMenu == 3){ //Per ora il valore è 3, ma dopo dovrà essere 1 📌
                        ...
                        tempoInizio = System.nanoTime(); // Resetta il tempo per nuova run
                    }
                ...
                switch (sceltaMenu) {
                    case 1:
                        System.out.println("Per ora vuoto... Prova a inserire 3.. " + /n + "Autore: Francy-Coder | Data: 2024-2025");
